...
public class ProductoController {
    ...
    @PostMapping
    public ProductoDTO guardar(@RequestBody ProductoDTO productoDTO, @RequestHeader("Sucursal-ID") Long idSucursal) {
        return productoService.guardarConSucursal(productoDTO, idSucursal);
    }
